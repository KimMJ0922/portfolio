...
class PresentationApiControllerTest(
    ...
    fun testGetIntroductions() {
        ...
        var contentAsString = mvcResult.response.getContentAsString(StandardCharsets.UTF_8)
        var jsonArray = JSONArray(contentAsString)
    ...
    fun testGetResume() {
        ...
        val mvcResult = performGet(uri)
        var contentAsString = mvcResult.response.getContentAsString(StandardCharsets.UTF_8)
        var jsonObject = JSONObject(contentAsString)
